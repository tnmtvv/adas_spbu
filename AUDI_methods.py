...
class AUDIMethods:
    ...
    def create_open3d_pc(lidar, cam_image=None):
        ...
        if cam_image is None:
            ...
            colours = AUDIMethods.colours_from_reflectances(lidar['reflectance']) / (median_reflectance * 5)
    ...
    @staticmethod
    def map_lidar_points_onto_image(image_orig, lidar, local_colors, pixel_size=3, pixel_opacity=1):
